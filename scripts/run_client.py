...
def main() -> int:
    ...
    print(json.dumps({"role": "client", "config": config.summary()}, indent=2, sort_keys=True))
    if args.dry_run:
        return 0

    raise RuntimeError("Config-driven client runtime is not implemented yet; use --dry-run.")
