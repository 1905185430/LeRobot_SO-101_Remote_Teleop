...
See `docs/validation/VALIDATION.md` (`Validation Status`) for the full validation matrix and the current boundary between automated readiness and pending human hardware validation.
